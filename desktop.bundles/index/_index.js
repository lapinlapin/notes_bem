...
;
/* ..\..\desktop.blocks\main\main.js begin */
...
/* ..\..\desktop.blocks\main\main.js end */
;
/* ..\..\desktop.blocks\field-data\field-data.js begin */
modules.define('i-bem__dom', ['BEMHTML', 'events__channels'], function(provide, BEMHTML, channel, DOM) {
    DOM.decl('field-data', {      
        onSetMod: {
            'js': {
...
/* ..\..\desktop.blocks\field-data\field-data.js end */
;
...
/* ..\..\desktop.blocks\new-note-form\new-note-form.js end */
;
/* ..\..\desktop.blocks\header-note\header-note.js begin */
modules.define('i-bem__dom', ['BEMHTML', 'events__channels'], function(provide, BEMHTML, channel, DOM) {
...
/* ..\..\desktop.blocks\header-note\header-note.js end */
;
/* ..\..\desktop.blocks\menu-tools\menu-tools.js begin */
modules.define('i-bem__dom', ['BEMHTML', 'events__channels'], function(provide, BEMHTML, channel, DOM) {
...
/* ..\..\desktop.blocks\menu-tools\menu-tools.js end */
;
/* ..\..\desktop.blocks\find-notes\find-notes.js begin */
modules.define('i-bem__dom', ['BEMHTML', 'events__channels'], function(provide, BEMHTML, channel, DOM) {
    DOM.decl('find-notes', {      
        onSetMod: {
            'js': {
...
/* ..\..\desktop.blocks\find-notes\find-notes.js end */
;
/* ..\..\desktop.blocks\info\info.js begin */
modules.define('i-bem__dom', ['BEMHTML', 'events__channels'], function(provide, BEMHTML, channel, DOM) {
...
/* ..\..\desktop.blocks\info\info.js end */
;
